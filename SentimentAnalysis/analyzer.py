...
class SentimentAnalyzer:
    def __init__(self, positive_words_file, negative_words_file):
        ...
        self.__quantifiers = {
            "really": 1.15, "at-all": 1.25, "absolutely": 1.3, "totally": 1.27,
    ...
    # Function to calculate sentiment of sentences, handling conjunctions
    def evaluate_sentiment(self, message):
        ...
        if not any(conjunction in message for conjunction in self.__conjunctions):
            return self.__compute_sentiment(message)
        ...
        for sentence in sentences:
            ...
            print(sentence, ": sentiment score= ", sentiment_score)

    # Function to compute the sentiment of a message
    def __compute_sentiment(self, message):
        words = message.split()
        ...
        return 0.755 * atan(sentiment_score)

    # Function to adjust the sentiment score based on negations
    @staticmethod
    ...
    # Function to handle conjunctions and split sentences accordingly
    ...
    # Function to process the message by cleaning and preparing it for analysis
    @staticmethod
    ...
    # Function to log sentiment analysis details (currently not implemented)
